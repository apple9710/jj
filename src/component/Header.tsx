...
const Header: React.FC = () => {
  return (
    <header className="sticky top-0 bg-white flex flex-row justify-start items-center w-full h-[90px] border shadow-[1px_1px_20px_-10px_rgba(0,0,0,0.3)]">
      <Link to={"/"} className="flex justify-center items-center w-full max-w-[380px]">
        <img src="/jj/Logo_Large.png" alt="logo" className="w-[166px]" />
      </Link>
        <nav className="flex flex-row justify-around items-center w-full max-w-[1200px] px-[16px]">
          ...
          {/* <Link to={"/board"} className="min-w-[90px] mx-[16px] font-bold text-[20px]">공지사항</Link> */}
        </nav>
    </header>
  );
};
